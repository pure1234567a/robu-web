...
var ServiceApiService = /** @class */ (function () {
    ...
    ServiceApiService.prototype.getProd = function () {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/productsrabu').toPromise();
    };
    ServiceApiService.prototype.getProdById = function (_id) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/productsrabu/' + _id).toPromise();
    };
